...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Runnable onStart = new Runnable() { @Override public void run() { System.out.println("CCRM is ready to use. Data folder :" + config.getDataFolder()); }};
        onStart.run();
        ...
        outer: while (!exit) { 
            ...
            switch (choice) {
                ...
                case "99": System.out.println("Labeled break demo"); break outer;
            ...
            try {
                switch (c) {
                    case "1":
                        ...
                        break;
                    case "2":
                        System.out.print("Registration Number: "); String r2 = scanner.nextLine();
                        ...
                        break;
                    case "3":
                        System.out.print("Registration Number: "); String r3 = scanner.nextLine();
